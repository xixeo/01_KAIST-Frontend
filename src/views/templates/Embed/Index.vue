<template>
  ...
  <!--<div>
      <h2>Embed template 페이지</h2>
  </div>-->
  <div class="hasNavAndTags" :class="this.$store.state.menu.flag.fullscreen?'isFullView':''">
    <embed type="text/html" src="http://106.240.255.66:9386" width="100%" height="100%">
  </div>
</template>
